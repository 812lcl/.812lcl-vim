...
function! s:vista_tag() abort
  return SpaceVim#layers#core#statusline#_vista_current_tag()
endfunction

function! SpaceVim#layers#core#statusline#_vista_current_tag() abort
  let tag = ''
  try
...
let s:registed_sections = {
      ...
      \ 'vista tag' : function('s:vista_tag'),
      \ }
...
function! SpaceVim#layers#core#statusline#init() abort
  augroup SpaceVim_statusline
    ...
    autocmd WinLeave * call SpaceVim#layers#core#statusline#remove_section('vista tag')
