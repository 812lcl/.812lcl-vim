...
" Insert mode                                    " fg             & bg
let s:I1 = [ '#080808' , '#ffaf00' , 232 , 214 ] " gray3          & brightestorange

" Visual mode                                    " fg             & bg
let s:V1 = [ '#005f5f' , '#ffffff' , 23  , 231 ] " darkestcyan    & white
...
let g:airline#themes#powerlineish#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:N3)
let g:airline#themes#powerlineish#palette.insert_replace = {
      \ 'airline_a': [ s:RE[0]   , s:I1[1]   , s:RE[1]   , s:I1[3]   , ''     ] }

let g:airline#themes#powerlineish#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:N3)

let g:airline#themes#powerlineish#palette.replace = airline#themes#generate_color_map(s:RE, s:N2, s:N3)
